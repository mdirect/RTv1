...
/*   Updated: 2020/03/12 16:11:08 by mdirect          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	make_scene(t_scene *scene)
{
	...
	scene->sph[1] = make_sphere((t_point){-0.2, -1.0, 6.0}, 1.5, 0xFF0000);
	scene->sph[2] = make_sphere((t_point){2.0, 3.0, 10.0}, 1.0, 0x0000FF);
	scene->sph[3] = make_sphere((t_point){6.2, -1.5, 17.0}, 2.0, 0x00FFCC);
	scene->sph[4] = make_sphere((t_point){0, -500.0, 5.0}, 499.0, 0xFFCC00);
}
