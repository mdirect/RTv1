...
void	scene_1(t_scene *scene)
{
	...
	scene->sph[0] = make_sphere((t_point){-2.0, 0.0, 7.0}, 1.2,
			(t_point){0, 255, 0}, 100.0, 0.5);
	scene->sph[1] = make_sphere((t_point){-0.2, -1.0, 6.0}, 1.5,
			(t_point){255, 0, 0}, 50.0, 0.4);
	scene->sph[2] = make_sphere((t_point){2.0, 3.0, 10.0}, 2.0,
			(t_point){0, 0, 255}, 100.0, 0.6);
	scene->sph[3] = make_sphere((t_point){6.2, -1.5, 17.0}, 2.0,
			(t_point){0, 255, 255}, 10.0, 0.3);
	scene->sph[4] = make_sphere((t_point){0, -500.0, 5.0}, 499.0,
